...
export function Sidebar({ open, onClose, isMobile }) {
      ...
      {isMobile && open && (
        <div
          ...
          style={{
            ...
            background: 'rgba(0,0,0,.5)', zIndex: 39,
          }}
        />
      )}

      <aside style={{
        width: isMobile ? '75vw' : 'clamp(220px, 25vw, 280px)',
        flexShrink: 0,
        height: '100%',
        maxHeight: '100%',
        ...
        transition: isMobile ? 'transform .3s ease' : 'none',
